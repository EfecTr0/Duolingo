...
class _MainScreenState extends State<MainScreen> {
  int _currentIndex = 0; // 0 - Профиль, 1 - Меню, 2 - Коллекция, 3 - Настройки
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _EmojiButton(emoji: '📚', label: 'Коллекция', onPressed: () => _onTabChange(2)),
  ...
  Widget _buildCurrentScreen() {
    switch (_currentIndex) {
      ...
      case 2:
        return const CollectionScreen(key: ValueKey('collection'));
      case 3:
