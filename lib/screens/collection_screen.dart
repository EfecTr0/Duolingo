...
class _CollectionScreenState extends State<CollectionScreen> {
  ...
  List<StudiedWord> get _filteredWords {
    // Создаём копию списка, чтобы можно было сортировать
...
class _WordCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color borderColor;
    if (word.successRate >= 0.8) borderColor = Colors.green;
    else if (word.successRate >= 0.5) borderColor = Colors.orange;
          ...
          children: [
            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    playClickSound();
                    PlayerData().toggleFavorite(word.english);
                    onRefresh();
                  },
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  '$successPercent%',
                  style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: borderColor),
                ),
              ],
            ),
          ],
...
// Экран детального просмотра слова с возможностью тестирования
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Последнее повторение: ${_formatDate(widget.word.lastSeen)}',
