...
class _MixedGameScreenState extends State<MixedGameScreen> with TickerProviderStateMixin {
  ...
  void _checkCardAnswer() {
    ...
    if (userAnswer == correctAnswer) {
      ...
      PlayerData().addOrUpdateWord(_cardWords[_cardIndex].english, _cardWords[_cardIndex].russian, widget.difficulty, true);
      setState(() {
      ...
      PlayerData().addOrUpdateWord(_cardWords[_cardIndex].english, _cardWords[_cardIndex].russian, widget.difficulty, false);
