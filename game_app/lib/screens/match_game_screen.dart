...
class _MatchGameScreenState extends State<MatchGameScreen> {
  ...
  List<MatchPair> _allMatchPairs = []; // все попытки сопоставления за игру
  ...
  void initState() {
    ...
    _totalSets = 4 + math.Random().nextInt(3);
    _generateSet();
  }
  ...
  void _onRussianTap(String russian) {
    ...
    if (selectedWord.russian == russian) {
      ...
      _allMatchPairs.add(MatchPair(english: selectedWord.english, russian: selectedWord.russian, isCorrect: true));
      ...
      _attemptsLeftInSet--;
      _allMatchPairs.add(MatchPair(english: _selectedEnglishWord!, russian: russian, isCorrect: false));
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      ...
                      Navigator.pop(context, {
                        ...
                        'attempts': _allMatchPairs.map((p) => {
                          'english': p.english,
                          'correctRussian': p.russian,
                          'userAnswer': p.isCorrect ? p.russian : 'неверно',
